  ...
  return (
    <div className="App">
      ...
      <div className="section_wrapper">  
        ...
        <li>&emsp;&emsp;ACK: receiver sends acknowledgements for segments.</li>
        <li>&emsp;&emsp;Timer: sender waits for receiver's ACK. If ACK is not received before timeout, retransmit.</li>
        <li>&emsp;&emsp;Retransmission: use ACK and timer to assist this. </li>
        <li>&emsp;&emsp;Duplicate data detection: discard the duplicates.</li>
        <li>&emsp;&emsp;Sequencing: each transmitted segment has sequence #, used to keep track in case out of order.</li>
    ...
    <br></br>
        ...
        <button><Link to="/transport/Transport_sub2">Connection & Control</Link></button>
