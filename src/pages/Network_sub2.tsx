    ...
    <div className="App">
      <header className="App-header">
        <div className="section_wrapper">
          ...
          <p>
            Network links have MTU(maximum transfer unit) size. This causes an
            IP datagram to be fragmented to several datagrams.
          </p>
          <img
            src={fragmentation_img}
            alt="fragmentation"
            width="400"
            height="100"
          ></img>
          ...
          <ul>
            ...
            <li>
              MF: this datagram is part of fragment and an additional fragment
              follows.
            </li>
          </ul>
          <p>Identification</p>
          <ul>
            ...
            <li>
              When a datagram is fragmented, the ID is same in all fragments.
            </li>
          </ul>
          <p>Fragment offset</p>
          <ul>
          ...
          <img
            src={frag_example_img}
            alt="fragmentation example"
            width="600"
            height="200"
          ></img>
        </div>
