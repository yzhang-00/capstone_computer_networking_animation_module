        ...
        <div className="section_wrapper">
            ...
            <h2>Routing table</h2>
              ...
              <p><strong>IP Forwarding</strong>: Pass a packet from an input interface to the output interface of a router</p>
                <img src={routing_components_img} alt="IPv4 IPv6"width="500" height="300" ></img>
              <p>Routing table lookup: Longest prefix match</p>
              <img src={lookup_img} alt="routing table lookup"width="250" height="250"></img>
            ...
            <h2>Routing Protocols</h2>
                <h4>RIP</h4>
                <p>A simple intradomain routing protocol.
                Each router broadcasts its routing infomation every 30 seconds (or whenever its routing table changes) to its neighbors.
                ...
                <img src={rip_rt_adv_img} alt="RIP routing table"width="500" height="200"></img>
                ...
                <img src={rip_receive_img} alt="RIP routing v receive advertisement"width="500" height="200"></img>
                ...
                <img src={ospf_routing_img} alt="OSPF routing mechanism" width="500" height="200"></img>
                ...
                <img src={rip_ospf_bgp_img} alt="BGP and RIP,OSPF relationship" width="450" height="100"></img>
                ...
                <img src={BGPpeer_adv_img} alt="BGP peers advertise path" width="350" height="200"></img>
                <p>For example: BGP advertisement from AS1 to AS10 would be: 10.0.1.0/24 AS-PATH=1 </p>

        </div>


        <button><Link to="/network">Introduction</Link></button>
